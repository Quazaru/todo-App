...
class TodoListItem extends React.Component {
  render() {
    const liStyle = {
      color: this.props.important ? 'tomato' : '#000' ,
    };
    return (
        <span className='todo-list-item'>
          ...
          <button className='delete-icon'><svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-x-octagon" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          ...
          <button className='important-icon'>
